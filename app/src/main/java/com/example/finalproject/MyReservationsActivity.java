...
public class MyReservationsActivity extends AppCompatActivity {
    ...
    public void loadRecycler() {
        ...
        String endpoint = "userReservedRooms.php";
        if (PublicData.loggedType.equals(PublicData.userTypeCustomer)) {
            endpoint += "?userEmail="+PublicData.loggedEmail;
        }
        BackendRequests.getRequest(endpoint, this, (response, success) -> {
