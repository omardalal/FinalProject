...
public class BackendRequests {
    ...
    public static void postRequest(String endpoint, Context context, Map<String, String> params, Class<?> successActivity) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!jsonObject.getBoolean("error")) {
                        Intent intent = new Intent(context, successActivity);
